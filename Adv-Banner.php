...
$des = array("\n\033[94m\033[01m   █████╗ ██████╗ ██╗   ██╗ █████╗ ███╗   ██╗ ██████╗███████╗",
       ...
       "\n\033[39m      ╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═══╝╚═╝  ╚═══╝╚══════╝╚═╝  ╚═╝",
       "\n\t\t\t\t\t\t\033[93m    php",
       "\n\n\t\033[01m\033[32m    [+] Coded By DNReporters\n",
       "\t\033[32m    [+] OWNER IS DNReporters \n\n");
foreach ($des as $de){
	print $de;
	usleep(20000);
	}
...
if ( $a == 1 ){
	$link = array("https://chat.whatsapp.com/LZZter8LZc22ZeQhg5LPPq",
		      "https://github.com/DNReporters",
		      "https://chat.whatsapp.com/LZZter8LZc22ZeQhg5LPPq",
...
elseif ( $a == 3 ){
	logo();
	$about = array("\n\033[44m\033[39mDNReporters DNReporters DNReporters DNReporters DNReporters DNReporters\033[49m\n\n",
              "\n\033[93m\t     \033[40mCoded By DNReporters\033[49m\n",
              "\n\033[93m\t     \033[40mBy DNReporters (A Technical channell )\033[49m\n",
              "\n\033[93m\t     \033[40mBy:\033[49m\n",
	      "\033[93m\t\t     \033[40mDNReporters \033[49m\n",
              "\n\033[93m\t     \033[40mJoin us:\033[49m\n",
	      "\033[93m\t\t     \033[40mWhatsapp: https://chat.whatsapp.com/LZZter8LZc22ZeQhg5LPPq\033[49m\n\n\n",
	      "\033[44m\033[39mDNReporters DNReporters DNReporters DNReporters DNReporters DNReporters\033[49m\n\n" );
...
elseif ( $a == 4 ){
	logo();
	$arr = array( "\n\t\t\033[40m\033[93m[1] Whatsapp\033[49m\n",
                 "\t\t\033[40m\033[93m[2] Youtube\033[49m\n",
	...
	if ( $jc == 1 ){
		system("xdg-open https://chat.whatsapp.com/LZZter8LZc22ZeQhg5LPPq");
		sleep(5);
		logo();
		menu();
		}
	elseif ( $jc == 2 ){
		system("xdg-open https://youtube.com/channel/UCKseX0yWAWiv5L1d4Ui9lIw");
		sleep(5);
		logo();
		menu();
		}
